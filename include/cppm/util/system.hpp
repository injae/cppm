...
namespace cppm::util::system
{
        ...
        #define CPPM_PLATFORM_NAME "linux" // Debian, Ubuntu, Gentoo, Fedora, openSUSE, RedHat, Centos and other
    #elif defined(__unix__) || defined(__APPLE__) && defined(__MACH__)
        #include <sys/param.h>
        #if defined(BSD)
            #define CPPM_PLATFORM_NAME "bsd" // FreeBSD, NetBSD, OpenBSD, DragonFly BSD
        #endif
    #elif defined(__hpux)
        #define CPPM_PLATFORM_NAME "hp-ux" // HP-UX
    #elif defined(_AIX)
        #define CPPM_PLATFORM_NAME "aix" // IBM AIX
    #elif defined(__APPLE__) && defined(__MACH__) // Apple OSX and iOS (Darwin)
        #include <TargetConditionals.h>
        #if TARGET_IPHONE_SIMULATOR == 1
            #define CPPM_PLATFORM_NAME "ios" // Apple iOS
        #elif TARGET_OS_IPHONE == 1
            #define CPPM_PLATFORM_NAME "ios" // Apple iOS
        #elif TARGET_OS_MAC == 1
            #define CPPM_PLATFORM_NAME "osx" // Apple OSX
        #endif
    #elif defined(__sun) && defined(__SVR4)
        #define CPPM_PLATFORM_NAME "solaris" // Oracle Solaris, Open Indiana
    #else
        #define CPPM_PLATFORM_NAME NULL
    #endif
        
    constexpr const char* what() { return (CPPM_PLATFORM_NAME == NULL) ? "" : CPPM_PLATFORM_NAME; }
